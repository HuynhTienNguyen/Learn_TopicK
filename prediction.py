...
task_names = ["cms"]
model_names = ['Qwen/Qwen2.5-0.5B-Instruct'] # 'Llama-3.2-3B-Instruct' 'Qwen2.5-0.5B-Instruct' 'Llama-3.2-1B-Instruct'
seeds = [1]
...
for task_name in task_names:
    ...
    for model_name in model_names:
        ...
        prediction_dir = os.path.join(dir1, model_name, task_name)
        
        print("Checking:", prediction_dir)
        print("Resolved path:", os.path.abspath(prediction_dir))
